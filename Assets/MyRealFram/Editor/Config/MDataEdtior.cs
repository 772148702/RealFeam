...
namespace MyRealFrame
{
    public class MDataEdtior
    {
        ...
        public static void ClassToXml(string name)
        {
            ...
            try
            {
                ...
                if (type != null)
                {
                    ...
                    MyRealFrame.BinarySerializeOpt.XmlSerialize(xmlPath, temp);
        ...
        public static void ClassToBinary(string name)
        {
            if (string.IsNullOrEmpty(name))
            {
                return;
            ...
            try
            {
                ...
                {   
                    ...
                    MyRealFrame.BinarySerializeOpt.BinarySerialize(binaryPath, temp);
                    Debug.Log(name + "类转bytes成功，bytes路径为:" + binaryPath);
                }
